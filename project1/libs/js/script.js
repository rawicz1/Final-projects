        ...
        $.ajax({
            ...
            success: function(result) {  
                ...
                for (let i = 0; i < result.articles.length; i++){                    
                    ...
                    $("#news-body").append('<div class="news-article" id="'+ newsID + '"><img src="" ><div class="article-body" id="'+articleBodyID+'"><h6></h6><div class="article-body-details" id="'+articleDetailsID+'"></div></div></div><hr>')
